...
const DiagnosticLogin = () => {
  ...
  const handleLogin = async () => {
    try {
      ...
      // Check if diagnostic is registered
      ...
      const diagnosticDetails = await contract.methods.getDiagnosticDetails(hhNumber).call();

      // Update context & localStorage
      login("diagnostic", hhNumber, window.ethereum.selectedAddress);

      // Redirect to diagnostic dashboard
