...
contract PatientRegistration {
    ...
    uint256 private patientCounter = 1;
    ...
    function registerPatient(
        ...
        string memory hhNumber = _generatePatientHH();
        require(!isPatientRegistered[hhNumber], "Patient already registered");
        ...
        patients[hhNumber] = newPatient;
        isPatientRegistered[hhNumber] = true;
        emit PatientRegistered(hhNumber, _name, _walletAddress);
    }
    ...
    function _generatePatientHH() internal returns (string memory) {
        uint256 hh = 990000 + patientCounter;
        patientCounter++;
    ...
    function getNextPatientHH() external view returns (string memory) {
    uint256 nextHH = 990000 + patientCounter;
