...
import ViewDiagnosticPrescriptions from "./components/ViewDiagnosticPrescriptions";
  ...
  return (
    <BrowserRouter>
      ...
      <Route path="/AboutPage" element={<AboutUs></AboutUs>}></Route>
        ...
        ></Route>
        <Route
          path="/diagnostics/:hhNumber/upload/:recordId"
        ...
        <Route
          path="/patient/:hhNumber/viewpatientprofile"
          element={<ViewProfile />}
        ></Route>
        <Route
        ...
        ></Route>
        <Route path="/patient/:hhNumber/viewPrescription" element={<ViewPrescription />} />
<Route
  path="/diagnostic/:hhNumber/viewdiagnosticprescriptions"
  element={<ViewDiagnosticPrescriptions />}
/>
